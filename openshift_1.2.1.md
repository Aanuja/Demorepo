  ...
  1. The scripts need to be modified: 
    ...
    * `hack/common.sh`, change some variables and add s390x support.
       ...
       +  linux/s390x
               ...
               images/pod
       @@ -53,6 +54,7 @@ readonly OS_CROSS_COMPILE_PLATFORMS=(
               darwin/amd64
               windows/amd64
               linux/386
       +  linux/s390x
               ...
               cmd/openshift
       @@ -144,9 +146,11 @@ os::build::host_platform_friendly() {
       ...
       @@ -311,6 +315,7 @@ os::build::build_binaries() {
               fi
       ...
       @@ -433,14 +438,16 @@ os::build::place_bins() {
               elif [[ $platform == "linux/386" ]]; then
